...
import { singledomainWithSsrMiddleware } from '@/app/recommendations/singledomain-with-ssr/singledomain-with-ssr-middleware';
import { apiDomainWithSsrMiddleware } from '@/app/recommendations/api-domain-with-ssr/api-domain-with-ssr-middleware';
import { apiAuthDomainWithSsrMiddleware } from '@/app/recommendations/api-auth-domains-with-ssr/api-auth-domain-with-ssr-middleware';
